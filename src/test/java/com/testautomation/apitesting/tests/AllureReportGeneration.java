...
public class AllureReportGeneration extends BaseTest{
	...
	private static final Logger logger= LogManager.getLogger(AllureReportGeneration.class.getName());

	@Story("Sotry 1")
	@Test(description = "end to end Api testing ..")
	@Description("E2e Api Test Description")
